...
//   if(translationPopup) {
//     translationPopup.id = 'ninebotai-transpop-id';
//     translationPopup.style.display = 'none';
//     translationPopup.style.position = 'absolute';
//     translationPopup.style.zIndex = '9999';
//     translationPopup.style.backgroundColor = '#ecfbf4';
//     translationPopup.style.color = 'black';
//     translationPopup.style.padding = '10px';
//     translationPopup.style.borderRadius = '8px';
//     translationPopup.style.boxShadow = '0 4px 12px #b3e3bd';
